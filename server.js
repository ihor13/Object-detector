...
app.use(express.static(path.join(__dirname, './media/video')))
...
app.get('/webcamBodyPix', (req, res) => res.sendFile(path.join(viewsDir, 'webcamBodyPix.html')))
app.get('/webcamPoseNet', (req, res) => res.sendFile(path.join(viewsDir, 'webcamPoseNet.html')))
app.get('/WebcamCocoSSDDetector', (req, res) => res.sendFile(path.join(viewsDir, 'WebcamCocoSSDDetector.html')))
app.get('/WebcamYOLODetector', (req, res) => res.sendFile(path.join(viewsDir, 'WebcamYOLODetector.html')))
